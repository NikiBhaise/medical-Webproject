...
<html>
<head>
<link rel="stylesheet" href="../css/admHomeStyle.css">
...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
   ...
   <%String email=session.getAttribute("email").toString(); %>
            <center><h2> Medical Management System </h2></center>
            ...
            <a href="../logout.jsp">Logout <i class='fas fa-share-square'></i></a>   <br><br>
          </div>
           <br>
